...
import hcmute.fonestore.notificationFragment.notificationFragment;
...
public class RecyclerViewAdapterNotification extends RecyclerView.Adapter<RecyclerViewAdapterNotification.MyViewHolder> {
    ...
    public RecyclerViewAdapterNotification(notificationFragment mContext, List<category2> mData) {
