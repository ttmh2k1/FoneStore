...
public class listSamsungFragment extends Fragment {
    ArrayList<category2> samsung, tablet;
    Button category;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        samsung.add(new category2("Điện thoại Samsung", R.drawable.img_samsung));
        ...
        tablet.add(new category2("Máy tính bảng Samsung", R.drawable.img_tablet));
