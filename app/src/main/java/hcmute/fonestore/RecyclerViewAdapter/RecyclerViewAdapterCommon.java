...
public class RecyclerViewAdapterCommon extends RecyclerView.Adapter<RecyclerViewAdapterCommon.MyViewHolder> {
    private Context context;
    private ArrayList<Product> data;

    public RecyclerViewAdapterCommon(Context context, ArrayList<Product> data) {
