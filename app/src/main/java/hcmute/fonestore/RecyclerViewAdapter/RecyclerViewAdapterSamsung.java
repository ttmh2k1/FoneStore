...
public class RecyclerViewAdapterSamsung extends RecyclerView.Adapter<RecyclerViewAdapterSamsung.MyViewHolder> {
    private Context mContext ;
    private List<CategoryWithThumnail> mData ;

    public RecyclerViewAdapterSamsung(Context mContext, List<CategoryWithThumnail> mData) {
