...
public class RecyclerViewAdapterXiaomi extends RecyclerView.Adapter<RecyclerViewAdapterXiaomi.MyViewHolder> {
    private Context mContext ;
    private List<CategoryWithThumnail> mData ;

    public RecyclerViewAdapterXiaomi(Context mContext, List<CategoryWithThumnail> mData) {
