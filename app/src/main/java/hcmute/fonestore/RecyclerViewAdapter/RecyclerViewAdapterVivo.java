...
public class RecyclerViewAdapterVivo extends RecyclerView.Adapter<RecyclerViewAdapterVivo.MyViewHolder> {
    private Context mContext ;
    private List<CategoryWithThumnail> mData ;

    public RecyclerViewAdapterVivo(Context mContext, List<CategoryWithThumnail> mData) {
