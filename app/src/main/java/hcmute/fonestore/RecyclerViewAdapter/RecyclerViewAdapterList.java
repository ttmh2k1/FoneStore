...
import hcmute.fonestore.fragment.category.listIphoneFragment;
import hcmute.fonestore.fragment.category.listPhukienFragment;
import hcmute.fonestore.fragment.category.listSamsungFragment;
import hcmute.fonestore.fragment.category.listVivoFragment;
import hcmute.fonestore.fragment.category.listXiaomiFragment;
...
public class RecyclerViewAdapterList extends RecyclerView.Adapter<RecyclerViewAdapterList.MyViewHolder> {
    ...
    public RecyclerViewAdapterList(listFragment mContext, List<CategoryWithThumnail> mData) {
